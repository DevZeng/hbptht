    ...
    handleLogin() {
      ...
      that.$refs.AccountFrom.validate(valid => {
        if (valid) {
          ...
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__api_api__["a" /* requestLogin */])(aaaa).then(res => {
            // let { msg, data } = res;
            if (res.msg == "ok") {
...
var update = __webpack_require__(272)("3656feae", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(272)("1e629553", content, true);
