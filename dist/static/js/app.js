...
var hosturl = 'https://yun.fengniaotuangou.cn';
...
var getself = exports.getself = function getself(params) {
	return _axios2.default.get(base + '/self/getaddress' + ('' + params)).then(function (res) {
		return res.data;
	});
};
var addself = exports.addself = function addself(params) {
	return _axios2.default.post(base + '/self/addaddress', params).then(function (res) {
		return res.data;
	});
};
var delself = exports.delself = function delself(params) {
	return _axios2.default.post(base + '/self/deleteaddress', params).then(function (res) {
		return res.data;
	});
};
...
var qiniu = {
	...
	token: 'jIFPDW2kqbYITI0cBU8wxLdi0W420Ieb98cB7Qou:BLwpSoJJdmSB3OzQy-JhEIEbawg=:eyJzY29wZSI6InR1YmFudW8iLCJkZWFkbGluZSI6MTYyNTcxMjk3NH0=',
...
var _Console = __webpack_require__(254);

var _Console2 = _interopRequireDefault(_Console);

var _Goodlist = __webpack_require__(241);

var _Goodlist2 = _interopRequireDefault(_Goodlist);

var _Goodtype = __webpack_require__(244);

var _Goodtype2 = _interopRequireDefault(_Goodtype);

var _Goodnew = __webpack_require__(242);

var _Goodnew2 = _interopRequireDefault(_Goodnew);

var _Goodself = __webpack_require__(243);

var _Goodself2 = _interopRequireDefault(_Goodself);

var _Joinlist = __webpack_require__(238);

var _Joinlist2 = _interopRequireDefault(_Joinlist);

var _Orderlist = __webpack_require__(247);
...
var _Proxylist = __webpack_require__(239);

var _Proxylist2 = _interopRequireDefault(_Proxylist);

var _Sendmsg = __webpack_require__(246);

var _Sendmsg2 = _interopRequireDefault(_Sendmsg);

var _Baseset = __webpack_require__(248);

var _Baseset2 = _interopRequireDefault(_Baseset);

var _Wordset = __webpack_require__(252);

var _Wordset2 = _interopRequireDefault(_Wordset);

var _Wechatset = __webpack_require__(251);

var _Wechatset2 = _interopRequireDefault(_Wechatset);

var _Document = __webpack_require__(250);

var _Document2 = _interopRequireDefault(_Document);

var _Delivelist = __webpack_require__(249);
...
var Login = function Login(resolve) {
    return __webpack_require__.e/* require */(0).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(277)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
};
...
var router = new _vueRouter2.default({
    ...
    routes: [{
        ...
        menuShow: true,
        iconCls: 'iconfont menu-good',
        children: [{ path: '/Good/Goodself', component: _Goodself2.default, name: "自提地址", menuShow: true, meta: { permission: '' } }]
    }, {
        leaf: true,
        path: '/',
        name: '拼团分类',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__api_api__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__api_api___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__api_api__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api_qiniu__ = __webpack_require__(11);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    checkid() {
      ...
      if (groupid) {
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__api_api__["groupGet"])(allParams).then(res => {
          ...
          this.groupself = Object.values(res.data.self);
          this.selfshow = true;
          this.checkboxed(this.groupself);

          //console.log(this.newone.self)
          var images = [];
    ...
    agetself() {
      var id = "";
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__api_api__["getself"])(id).then(res => {
        this.newone.self = res.data;
      });
    },

    changeRadio() {
      if (this.newone.delivery === "1" || this.newone.delivery === "3") {
        this.agetself();
        this.selfshow = true;
      } else if (this.newone.delivery === "2") {
    ...
    addselfid(val) {
      ...
      this.newone.selfid.push(sid);
      console.log(this.newone.selfid);
    },
    ...
    checkboxed(rows) {
      ...
      if (rows) {
        var checkList = [];
        rows.forEach(row => {
          checkList.push(row.sid);
          console.log(123456, checkList);
        });
        this.checkedself = checkList;
        console.log(222, this.checkedself);
      } else {
        this.$refs.selftable.clearSelection();
      }
    },
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    newone() {
      ...
      this.diatitle = '新增地址', this.dialogNewVisible = true, this.newadv = {
        store_name: '',
        address: ''
      };
    },
    ...
    save() {
      ...
      if (this.newadv.store_name == '' && this.nothree == true) {
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__api_api__["addself"])(allParams).then(res => {
          if (res.msg === "ok") {
            this.$message({
              message: '提交成功',
              type: 'success'
    ...
    submitdel() {
      ...
      var allParams = { id: this.delId };
      console.log(allParams);
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__api_api__["delself"])(allParams).then(res => {
        if (res.msg === "ok") {
          this.$message({
            message: '删除成功',
            type: 'success'
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__api_qiniu__ = __webpack_require__(11);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('el-row', {
  ...
  }, [_c('b', [_vm._v("首页")])]), _vm._v(" "), _c('el-breadcrumb-item', [_vm._v("自提地址")]), _vm._v(" "), _c('el-breadcrumb-item', [_vm._v("地址列表")])], 1)], 1), _vm._v(" "), _c('el-col', {
    staticClass: "warp-main",
    attrs: {
      "span": 24
    }
  ...
  }, [_vm._v("新增地址")])], 1)], 1), _vm._v(" "), _c('el-table', {
    staticStyle: {
      "width": "901px"
    },
    attrs: {
    ...
    model: {
      value: (_vm.newadv.store_name),
      callback: function($$v) {
        _vm.$set(_vm.newadv, "store_name", $$v)
      },
      expression: "newadv.store_name"
    }
  })], 1), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "详细地址："
    ...
    model: {
      value: (_vm.newadv.address),
      callback: function($$v) {
        _vm.$set(_vm.newadv, "address", $$v)
      },
      expression: "newadv.address"
    }
  })], 1), _vm._v(" "), _c('el-form-item', {
    staticStyle: {
      "margin-left": "calc(50% - 200px)"
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('el-row', {
    ...
    on: {
      "change": _vm.getcheckself
    },
    model: {
      value: (_vm.checkedself),
      callback: function($$v) {
        _vm.checkedself = $$v
      },
      expression: "checkedself"
    }
  }, _vm._l((_vm.newone.self), function(s) {
