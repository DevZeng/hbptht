    ...
    <el-col :span="24" class="warp-main">
      ...
      >
        ...
        <el-form-item label="选择自提地址" prop="self" v-show="selfshow">
           <el-checkbox-group v-model="checkedself" @change="getcheckself">
              <el-checkbox v-for="s in newone.self" :label="s.id" :key="s.id">{{s.store_name}}</el-checkbox>
            </el-checkbox-group>
        </el-form-item>
...
<script>
import { typeGet, comGetAll, deliveryDel } from "../../api/api";
